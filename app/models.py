...
class PedidoServico(Base):
    ...
    MatriculaSCAE: Mapped[Optional[str]] = mapped_column(String(50))
    NumeroOSSCAE: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    Urgencia: Mapped[Optional[str]] = mapped_column(String(50))
    PrazoConclusaoOS: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)
    DataAberturaSCAE: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime)
    DataCriacao: Mapped[Optional[datetime.datetime]] = mapped_column(DateTime, server_default=text('(getdate())'))
    StatusPedido: Mapped[Optional[str]] = mapped_column(String(20), server_default=text("('AGUARDANDO')"))
    Valor: Mapped[Optional[float]] = mapped_column(Float(53))
